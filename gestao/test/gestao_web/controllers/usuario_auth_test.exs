defmodule GestaoWeb.UsuarioAuthTest do
  use GestaoWeb.ConnCase, async: true

  alias Gestao.Contas
  alias GestaoWeb.UsuarioAuth
  import Gestao.ContasFixtures

  @remember_me_cookie "_gestao_web_usuario_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GestaoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_usuario/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GestaoWeb.Endpoint.subscribe(live_socket_id)
