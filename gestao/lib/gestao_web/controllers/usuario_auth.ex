defmodule GestaoWeb.UsuarioAuth do
  import Plug.Conn
  ...
  def log_out_usuario(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GestaoWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def require_authenticated_usuario(conn, _opts) do
    if conn.assigns[:current_usuario] do
      ...
      conn
      |> put_flash(:error, "Você deve fazer login para acessar essa página.")
