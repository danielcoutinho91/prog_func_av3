defmodule Gestao.Contas do
  ...
  alias Gestao.Contas.{Usuario, UsuarioToken, UsuarioNotifier}
  ...
  defp usuario_email_multi(usuario, email, context) do
    changeset = usuario |> Usuario.email_changeset(%{email: email}) |> Usuario.confirm_changeset()
