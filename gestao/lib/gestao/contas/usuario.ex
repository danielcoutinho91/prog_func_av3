defmodule Gestao.Contas.Usuario do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Gestao.Repo)
  ...
  """
  def valid_password?(%Gestao.Contas.Usuario{hashed_password: hashed_password}, password)
